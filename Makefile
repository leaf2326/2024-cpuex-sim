...
SRCDIR = src
OBJDIR = build
SRCS = $(SRCDIR)/Simulator.cpp $(SRCDIR)/Pipeline.cpp $(SRCDIR)/Log.cpp $(SRCDIR)/FPU.cpp $(SRCDIR)/Util.cpp $(SRCDIR)/Memory.cpp $(SRCDIR)/DiscordNotifier.cpp $(SRCDIR)/OptionHandler.cpp $(SRCDIR)/Predictor.cpp $(SRCDIR)/InstructionCache.cpp
