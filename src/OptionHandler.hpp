...
public:
    ...
    static constexpr size_t DEFAULT_L1LINES = 1024;
    static constexpr size_t DEFAULT_L2LINES = 5120;
    static constexpr size_t DEFAULT_LINESIZE = 64; // 512 bits
    static constexpr size_t DEFAULT_L2ASSOCIATIVITY = 5;
